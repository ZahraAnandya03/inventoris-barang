...
<head>
    ...
    <title>Daftar Barang Belum Kembali</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div id="peminjaman-barang" class="collapse">
            ...
            <a href="{{ route('peminjaman.barangBelumKembali')}}" class="ms-3"><i class="fas fa-file-alt"></i> Barang Belum Kembali</a>
        </div>
    ...
    <div class="container mt-4">
        <h2 class="mb-4">Daftar Barang Belum Kembali</h2>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $barang->pb_nama_siswa }}</td>
                    <td>{{ $barang->pb_no_siswa }}</td>
                    <td>{{ \Carbon\Carbon::parse($barang->pb_tgl)->format('d-m-Y') }}</td>
                    <td>{{ \Carbon\Carbon::parse($barang->pb_harus_kembali_tgl)->format('d-m-Y') }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
