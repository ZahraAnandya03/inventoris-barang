...
<div class="container">
    ...
    <form action="{{ route('jenis.store') }}" method="POST">
        @csrf  <!-- Tambahkan ini jika belum ada -->
        <div class="form-group">
            <label for="jns_brg_kode">Kode Jenis Barang:</label>
            <input type="text" name="jns_brg_kode" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="jns_brg_nama">Nama Jenis Barang:</label>
            <input type="text" name="jns_brg_nama" class="form-control" required>
        </div>
